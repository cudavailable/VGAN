...
if __name__ == "__main__":
	...
	parser.add_argument("--w_recon", type=float, default=39.0)
	...
	parser.add_argument("--tran_mean", type=tuple, default=(0.4914, 0.4822, 0.4465))
	parser.add_argument("--tran_std", type=tuple, default=(0.247, 0.243, 0.261))
